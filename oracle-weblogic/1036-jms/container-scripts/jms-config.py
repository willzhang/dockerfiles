...
propInputStream = FileInputStream("/root/Oracle/jms-config.properties")
...
domainhome = os.environ.get('DOMAIN_HOME', '/root/Oracle/Middleware/user_projects/domains/base_domain/' + domainname)
