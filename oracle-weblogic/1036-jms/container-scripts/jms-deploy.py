...
propInputStream = FileInputStream("/root/Oracle/jms.properties")
...
domainhome = os.environ.get('DOMAIN_HOME', '/root/Oracle/Middleware/user_projects/domains/' + domainname)
adminport = os.environ.get('LISTEN_PORT', '7001')
username = os.environ.get('ADMIN_USERNAME', 'weblogic')
password = os.environ.get('ADMIN_PASSWORD', '88888888')
...
queueNames1 = configProps.get("queue.name")
queueNames = (queueNames1.split(" "))
print(queueNames)
